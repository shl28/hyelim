...
public class StudentApp {
    ...
    private static void studentList() {
        ...
        for(int i = 0; i < studentsArray.length; i++){
            if (studentsArray[i] != null) {
                ...
                System.out.printf("%s %s %d %s %d %d %d %d %.2f\n", 
                    ...
                    student.getEng(),
                    student.getMath(),
                    student.calculateTotal(student.getKor(), student.getEng(), student.getMath()),
    ...
    private static void searchStudent() {
        ...
        if (student == null) {
            ...
            System.out.printf("학번: %s, 이름: %s, 나이: %d, 전공: %s, 국어 점수: %d, 영어 점수: %d, 수학점수: %d, 총점: %d, 평균: %.2f\n", 
                    student.getStudentId(),
                    student.getName(),
                    student.getAge(),
                    student.getMajor(),
