                ...
                <div className="about-grid">
                    <div className="about-text">
                        <p>
                            ...
                            and a keen eye for design, I bring ideas to life.
                        </p>
                        <p>
                            My goal is to build scalable, maintainable, and
                            user-friendly applications that make a difference. I
                        ...
                        <div className="service-card">
                            ...
                            <div>
                                ...
                                <p>
                                    ...
                                    user interfaces that enhance user
                                    experience.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="service-card">
                            ...
                            <div>
                                ...
                                <p>
                                    ...
                                    and implementing modern solutions.
                                </p>
                            </div>
                        </div>
                    </div>
