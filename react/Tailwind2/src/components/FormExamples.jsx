        ...
        <div className="space-y-4 max-w-md">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-hidden transition"
        ...
        <div className="space-y-4 max-w-md">
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-hidden transition bg-white"
            >
          ...
          <div>
            ...
            <textarea
              rows="4"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-hidden transition resize-none"
        ...
        <div className="max-w-md mx-auto bg-white border border-gray-200 rounded-xl shadow-lg p-8">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input
                type="email"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-hidden transition"
                placeholder="example@email.com"
              />
            </div>
            <div>
            ...
            <button
              type="submit"
              className="w-full py-3 bg-linear-to-r from-blue-500 to-purple-500 text-white rounded-lg font-semibold hover:shadow-md transform hover:scale-105 transition"
            >
              로그인
            </button>
